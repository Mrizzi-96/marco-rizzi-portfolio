    ...
    <div class="container-fluid">
      ...
      <div class="row">
        <div class="col-sm-12 col-md-4 flex-col" data-aos="fade-right" data-aos-duration="1000">
          <img class="profile-pic" src="../assets/images/portrait.png" alt="profile picture" />
        </div>
        <div class="col-sm-12 col-md-4 flex-col" data-aos="fade-right" data-aos-duration="1000">
          <p id="about-content">
        ...
        <div class="col-sm-12 col-md-4 flex-column" data-aos="fade-right" data-aos-duration="1000">
